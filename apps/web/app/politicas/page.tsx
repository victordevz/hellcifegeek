  ...
  return (
    <main className="policiesPage">
      ...
      <section className="policyBlock">
        ...
        <p>Parceiros aprovados pela Hellcife Geek recebem um código de cupom vinculado ao seu cadastro. Cada venda concluída com o uso desse código gera ao parceiro o direito a 10% sobre o valor total vendido naquela compra, salvo campanha ou ajuste específico acordado por escrito.</p>
